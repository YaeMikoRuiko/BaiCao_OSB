...
export default {
  ...
  methods:{
    load(){
      axios.get("http://localhost:8087/short",{
        params: {
    ...
    save(){
      if (this.form.id){//更新
        axios.put("http://localhost:8087/short",this.form).then(res =>{
          console.log(res);
          if (res.data.code==='0'){
            this.$message({
              type: "success",
        ...
        axios.post("http://localhost:8087/short",this.form).then(res =>{
          console.log(res);
          if (res.data.code==='0'){
            this.$message({
              type: "success",
    ...
    handleDelete(id){
      console.log(id);
      axios.delete("http://localhost:8087/short/"+id).then(res => {
        if (res.data.code==='0'){
          this.$message({
            type: "success",
            message: "删除成功"
